...
export const Solve2x1 = () => {
  ...
  console.log(`Day 2 Part 1 - ${result.horizontal * result.depth}`);
  //   1499229
};

export const Solve2x2 = () => {
  const result = input.split("\n").reduce(
    (prev, cur, i, arr) => {
      const splt = cur.split(" ");
      switch (splt[0]) {
  ...
  console.log(`Day 2 Part 2 - ${result.horizontal * result.depth}`);
  //   1340836560
};
